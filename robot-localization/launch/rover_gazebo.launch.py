...
def generate_launch_description():
    ...
    declare_use_respawn_cmd = DeclareLaunchArgument(
        'use_respawn',
        default_value = 'False',
        description = "Whether to respawn if a node crashes. Applied when composition is disbled."
    )
    ...
    declare_ bridge_params_cmd = DeclareLaunchArgument(
        'bridge_paramas', default_value = '', description='Extra parameters to pass to the bridge'
    )
